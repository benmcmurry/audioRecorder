...
$fileLocation = "uploads/prompt_".$_POST['prompt_id']."-".$_POST['owner']."-".$time.".webm";
...
$query->bind_param("sssss", $_POST['prompt_id'], $_POST['owner'], $fileLocation, $_FILES['myBlob']['size'], $_FILES['myBlob']['type']);
$query->execute();
